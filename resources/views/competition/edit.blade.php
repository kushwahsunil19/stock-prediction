        ...
        <div class="col-xl-12 col-md-12">
            <div class="card">
                ...
                <div class=" card-body row">
                    <form id="addaccountForm" method="POST" action="{{ route('competitions.update', $com->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        @php
                        ...
                        @foreach($com->participant as $key => $row)                    
                        @if($row->competition_id==$com->id)
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" class="form-control" id="name" name="name" value="{{ $com->name }}" required @if($status) readonly @endif>
                            </div>
                            <div class="col-md-6 mb-2">
                                <label for="package" class="form-label">Length of Sprint </label>
                                <input type="number" class="form-control" id="sprint" name="sprint" value="{{ $com->sprint }}" required @if($status ) readonly @endif>
                            </div>
                            <div class="col-md-6 mb-2">
                                <label for="package" class="form-label">Start Date </label>
                                <input type="date" class="form-control" id="startdate" name="startdate" value="{{ $com->startdate }}" required @if($status) readonly @endif>
                            </div>
                            <div class="col-md-6 mb-2">
                                <label for="package" class="form-label">End Date </label>
                                <input type="date" class="form-control" id="enddate" name="enddate" value="{{ $com->enddate }}" required @if($status ) readonly @endif>
                            </div>
                            <!-- <div class="col-md-6 mb-2">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                <label for="package" class="form-label">No of free token </label>
                                <input type="number" class="form-control" id="token_no" name="token_no" value="{{ $com->token_no }}" required @if($status ) readonly @endif>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                <label for="package" class="form-label">News Heading </label>
                                <input type="text" class="form-control" id="news_heading" name="news_heading" value="{{ $com->news_heading }}" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                <label for="package" class="form-label">Summary </label>
                                <textarea id="editor_summary" name="summary" class="form-control">{!! $com->summary !!}</textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                <label for="package" class="form-label">Rule of competition </label>
                                <textarea id="editor_rule" name="rule_of_competition" class="form-control" @if($status ) readonly @endif>{!! $com->rule_of_competition !!}</textarea>
                            </div>
                        </div>
