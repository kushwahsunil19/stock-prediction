...
<head>
    ...
    <style>
        ...
        .toggle span:before,
        .toggle span:after { $(document).ready(function() {
            ...
            "columnDefs": [
                {
                    ...
                    "ordesumitupkart100@gmail.comrable": false // Disable ordering for this column
                },
                {
    ...
    <div class="page-header d-flex align-items-center justify-content-between border-bottom mb-4">
        ...
        <div>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page" style="padding-left: 0px;">Accouns</li>
            </ol>
        </div>
    </div>
                  <form method="GET" action="{{ route('user.accounts') }}">
                        <div class="row mb-3">
                            <div class="col">              
...
@endphp
  ...
  <a href="{{ route('all-account-export-csv') . '?' . $query }}" class="btn btn-primary">Download CSV</a>
            ...
            <div class="card">
                ...
                <div class="card-body pt-4">
                    <div class="grid-margin">
                        ...
                        <!--{{ $userList->appends(['perPage' => $perPage])->links() }}-->
