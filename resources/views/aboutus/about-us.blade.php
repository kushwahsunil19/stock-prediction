    ...
    <div class="page-header d-flex align-items-center justify-content-between border-bottom mb-4">
        ...
        <div>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page" style="padding-left: 0px;">About Us</li>
            </ol>
        </div>
    </div>
            ...
            <div class="card">
                ...
                @if($data->isEmpty())
                    <button style="padding: 10px 20px; margin: 10px;" data-bs-toggle="modal" data-bs-target="#addaccountModal" class="btn btn-primary" id="accountBtn">
                        <i class="fa fa-plus fa-lg" aria-hidden="true"></i> Add About Us
                    </button>
                </div>
                @endif
                    ...
                    <div class="modal-dialog dialogue-width modal-xl">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="addaccountModalLabel">Add New About Us</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <!-- Add Account Form -->
                                <form id="addaccountForm" method="POST" action="{{ route('aboutus.store') }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                    ...
                                    <div class="row editor-ck">
                                        ...
                                        <!-- <input type="hidden" id="rule_of_About Us" name="rule_of_About Us"> -->
                                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <!-- Delete Button -->
                                            @if($data->isEmpty())
                                            <form action="{{ route('aboutus.destroy', $res->id) }}" method="Post" style="display: inline;">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this About Us?')">Delete</button>
                                            </form>
                                            @endif
                                        </td>
                                    ...
                                    <div class="modal fade" id="editpujaModal{{ $res->id }}" tabindex="-1" aria-labelledby="editpujaModalLabel{{ $res->id }}" aria-hidden="true">
                                        <div class="modal-dialog dialogue-width modal-xl">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="editpujaModalLabel{{ $res->id }}">Edit About Us</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <form id="editForm{{ $res->id }}" method="POST" action="{{ route('aboutus.update', $res->id) }}" enctype="multipart/form-data">
                                                        @csrf
                                                        @method('PATCH')
                                                        <div class="row">
                                                            <div class="col-md-12 mb-2">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('form[id^="editForm"]').forEach(function(form) {
                form.addEventListener('submit', function() {
                    ...
                    form.querySelector('input[name="rule_of_About Us"]').value = editorContent;
                });
            });
        });
        document.addEventListener('DOMContentLoaded', function() {
