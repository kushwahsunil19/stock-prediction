...
<section class="signin p-3 p-md-4 p-xl-5 body-bg-img ">
  <div class="container">
              ...
              <div class="row gy-3 overflow-hidden">
                <div class="col-12">
                  <div class="form-floating mb-3">
                    <input type="email" class="form-control" name="email" id="InputEmail" placeholder="name@example.com" value="{{ $email ?? old('email') }}" required readonly>
                ...
                <div class="col-12">
                  <div class="form-floating mb-3">
                    <input type="password" class="form-control" name="password_confirmation" id="InputPasswordConfirmation" placeholder="Confirm New Password" required>
                    <label for="InputPasswordConfirmation" class="form-label">Confirm New Password</label>
                  </div>
                </div>
                <div class="col-12">
                  <div class="d-grid">
