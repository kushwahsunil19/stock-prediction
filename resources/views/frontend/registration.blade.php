...
<section class="signin gradient-custom body-bg-img ">
                        ...
                        <form action="{{ route('postRegistration') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    <div data-mdb-input-init class="form-floating mb-3">
                                        <input type="text" id="Inputuser1" name="first_name" class="form-control form-control-lg" />
                                        <label class="form-label" for="Inputuser1">First Name</label>
                                ...
                                <div class="col-md-6 mb-4">
                                    <div data-mdb-input-init class="form-floating mb-3">
                                        <input type="text" id="Inputuser2" name="last_name" class="form-control form-control-lg" />
                                        <label class="form-label" for="Inputuser2">Last Name</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4 d-flex align-items-center">
                                    <div data-mdb-input-init class="form-floating mb-3 datepicker w-100">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4 pb-2">
                                    <div class="form-floating mb-3">
                                      <select class="form-select" name="country_code" id="InputCountryCode" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4 pb-2">
                                    <div data-mdb-input-init class="form-floating mb-3">
                                        <input type="password" class="form-control form-control-lg" name="password_confirmation" id="InputPassword2" placeholder="Confirm Password">
                            ...
                            <div class="text-center mt-3">Already have an account? <a href="{{ route('sign-in') }}">Sign In</a>
                            </div>
