              ...
              <div class="row gy-3 overflow-hidden">
                <div class="col-12">
                  <div class="form-floating mb-3">
                    <input type="email" class="form-control" name="email" id="Inputuser1" placeholder="name@example.com" required>
                    <label for="Inputuser1" class="form-label">Email</label>
                  </div>
                </div>
                <div class="col-12">
                  <div class="form-floating mb-3">
                    <input type="password" class="form-control" name="password" id="InputPassword1" value="" placeholder="Password" required>
                ...
                <div class="col-12">
                  <div class="d-grid">
                    <button class="btn bsb-btn-2xl btn-primary" type="submit">Sign In</button>
                  </div>
                </div>
              </div>
            </form>
